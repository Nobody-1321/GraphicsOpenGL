...
glm::vec3 cubePositions[] = {
    ...
    glm::vec3(0.2f,  0.35f,  0.2f),
    glm::vec3(0.3f,  0.35f,  0.505f),
    glm::vec3(0.4f,  0.35f,  0.3f),
    glm::vec3(0.5f,  0.35f,  0.550f),
    glm::vec3(0.0f,  0.35f,  0.420f),
    glm::vec3(-0.1f, 0.35f,  0.260f),
    glm::vec3(-0.2f, 0.35f,  0.390f),
    glm::vec3(-0.3f, 0.35f,  0.522f),
    glm::vec3(-0.4f, 0.35f,  0.502f)
};
...
void init() {
    ...
    grassTexture = Utils::loadTexture(".\\textures\\torus.jpg");
    ...
    grassTexture = Utils::loadTexture("./textures/grass.png");
...
void display(GLFWwindow *window)
{
    ...
    glActiveTexture(GL_TEXTURE0);           // Activate the texture unit first before binding texture
    glBindTexture(GL_TEXTURE_2D, grassTexture); // Bind the texture to the unit
    //glBindTexture(GL_TEXTURE_2D, floorTexture); // Bind the texture to the unit
